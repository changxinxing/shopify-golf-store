...
$('.toggle-trigger').click(function(e){
  ...
  $(this).closest('.toggle-item').find('.toggle-content').slideToggle(500);
});


/******************** FIX ORPHANS ***********************/
const articleElement = document.getElementById('MainContent');
const typeMateInstance = new typemate(articleElement, { selector: 'h1, h2, h3, h4, h5, h6, li, p' });
...
/***** Submit Registration *********/
$('#WholesaleRegisterForm').submit(function(e){
...
/***** SHIPPING TOOL TIP FOR MOBILE ****************/
    ...
    checkScreenSize();
    function checkScreenSize(newWindowWidth){
        var newWindowWidth = $(window).width();
      return newWindowWidth;
    }

$('.ship-message-label:not(.tool-tip-close)').click(function(e){
  if(checkScreenSize() < 750 ) {
...
if($('#shopify-section-ticker .ticker').length > 0){
  $(function(){
      $('.ticker').slick({
          variableWidth: true,
          autoplay: true,
